...
# by the `collective.aisettings.Capabilities` vocabulary. Anything not listed here is
...
def fetch_model_capabilities(uri: str, api_key: str | None, model: str) -> list[str]:
    ...
    ``collective.aisettings.Capabilities`` vocabulary; unknown values are dropped.
    """
