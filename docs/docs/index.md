...
myst:
  html_meta:
    ...
    "property=og:description": "Connect your AI models to Plone"
    "property=og:title": "Collective AI"
    "keywords": "Collective AI, documentation, Connect your AI models to Plone"
---

# Collective AI

Welcome to the documentation for Collective AI!
